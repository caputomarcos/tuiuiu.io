...
from tuiuiu.tuiuiusearch.index import FilterField, RelatedFields, SearchField
...
def get_model_root(model):
    ...
    Examples:
    >>> get_model_root(tuiuiucore.Page)
    tuiuiucore.Page

    >>> get_model_root(myapp.HomePage)
    tuiuiucore.Page

    >>> get_model_root(tuiuiuimages.Image)
    tuiuiuimages.Image
    """
...
class Elasticsearch2Mapping(ElasticsearchMapping):
    ...
    def get_all_content_types(self):
        ...
        For example: ["myapp.MyPageModel", "tuiuiucore.Page"]
                     ["myapp.MyModel"]
        """
...
class Elasticsearch2Index(ElasticsearchIndex):
    def add_model(self, model):
        ...
        self.es.indices.put_mapping(
            ...
            # see https://github.com/tuiuiu/tuiuiu/issues/2968
