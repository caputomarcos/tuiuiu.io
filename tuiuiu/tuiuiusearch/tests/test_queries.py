...
class TestQueryChooserView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        ...
        self.assertTemplateUsed(response, 'tuiuiusearch/queries/chooser/chooser.html')
        self.assertTemplateUsed(response, 'tuiuiusearch/queries/chooser/chooser.js')
