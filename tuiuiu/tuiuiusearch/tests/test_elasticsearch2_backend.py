...
from tuiuiu.tuiuiusearch.backends.elasticsearch2 import (
...
class TestElasticsearch2SearchBackend(BackendTests, TestCase):
    backend_path = 'tuiuiu.tuiuiusearch.backends.elasticsearch2'
...
class TestGetModelRoot(TestCase):
    ...
    def test_grandchild_model(self):
        ...
        from tuiuiu.tuiuiucore.models import Page
        from tuiuiu.tests.testapp.models import MTIChildPage
