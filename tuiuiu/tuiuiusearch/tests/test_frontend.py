...
from tuiuiu.tests.testapp.models import EventPage
...
class TestSearchView(TestCase):
    ...
    def test_get(self):
        response = self.client.get(reverse('tuiuiusearch_search'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_search(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Christmas')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_first_page(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&page=1')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_10th_page(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&page=10')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_invalid_page(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&page=Not a Page')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_out_of_range_page(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&page=9999')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_zero_page(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&page=0')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
    ...
    def test_get_10th_page_backwards_compatibility_with_p(self):
        response = self.client.get(reverse('tuiuiusearch_search') + '?q=Event&p=10')
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusearch/search_results.html')
