...
from tuiuiu.tuiuiusearch.utils import MAX_QUERY_STRING_LENGTH, normalise_query_string
...
class QueryDailyHits(models.Model):
    ...
    def garbage_collect(cls, days=None):
        ...
        """
        days = getattr(settings, 'TUIUIUSEARCH_HITS_MAX_AGE', 7) if days is None else days
