...
from tuiuiu.tuiuiucore.rich_text import DbWhitelister
...
class TestDbWhitelister(TestCase):
    ...
    def test_page_link_is_rewritten(self):
        input_html = (
            ...
            ' of my <a href="http://tuiuiu.io/">Tuiuiu</a> site</p>'
        )
    ...
    def test_whitelist_hooks(self):
        # tuiuiu.tests.tuiuiu_hooks overrides the whitelist to permit <blockquote> and <a target="...">
        input_html = (
