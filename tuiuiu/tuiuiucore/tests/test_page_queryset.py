...
from tuiuiu.tests.testapp.models import EventPage, SimplePage, SingleEventPage
from tuiuiu.tuiuiucore.models import Page, PageViewRestriction, Site
from tuiuiu.tuiuiucore.signals import page_unpublished
...
class TestPageQuerySet(TestCase):
    ...
    def test_type_includes_subclasses(self):
        from tuiuiu.tuiuiuforms.models import AbstractEmailForm
...
class TestSpecificQuery(TestCase):
    ...
    def test_specific_query_with_search(self):
        ...
        pages = list(Page.objects.specific().live().in_menu().search(None, backend='tuiuiu.tuiuiusearch.backends.db'))
