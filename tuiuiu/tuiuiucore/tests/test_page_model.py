...
from tuiuiu.tuiuiucore.models import Page, PageManager, Site, get_page_models
...
class TestRouting(TestCase):
    ...
    @override_settings(ROOT_URLCONF='tuiuiu.tests.non_root_urls')
...
class TestCopyPage(TestCase):
    ...
    def test_copy_page_copies_tags(self):
        ...
        tagged_page.tags.add('tuiuiu', 'bird')
...
class TestSubpageTypeBusinessRules(TestCase, TuiuiuTestUtils):
...
class TestPageManager(TestCase):
    ...
    def test_custom_page_manager(self):
        ...
        Tuiuiu should respect this. It is up to the developer to ensure their
    ...
    def test_abstract_base_page_manager(self):
        ...
        and Tuiuiu should respect this. It is up to the developer to ensure
