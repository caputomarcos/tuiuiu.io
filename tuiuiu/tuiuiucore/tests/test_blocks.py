...
from tuiuiu.tests.testapp.blocks import LinkBlock as CustomLinkBlock
from tuiuiu.tests.testapp.blocks import SectionBlock
from tuiuiu.tests.testapp.models import EventPage, SimplePage
...
class TestFieldBlock(TuiuiuTestUtils, SimpleTestCase):
...
class TestChoiceBlock(TuiuiuTestUtils, SimpleTestCase):
    def setUp(self):
...
class TestStructBlock(SimpleTestCase):
    ...
    def test_render_unknown_field(self):
        ...
        self.assertIn('<dd>Tuiuiu site</dd>', html)
        self.assertIn('<dt>link</dt>', html)
        self.assertIn('<dd>http://www.tuiuiu.io</dd>', html)
    ...
    def test_get_form_context(self):
        ...
        self.assertEqual(context['children']['title'].value, "Tuiuiu site")
        self.assertTrue(isinstance(context['children']['link'], blocks.BoundBlock))
        self.assertEqual(context['children']['link'].value, 'http://www.tuiuiu.io')
    ...
    def test_render_form(self):
        ...
        self.assertInHTML(
            '<input id="mylink-title" name="mylink-title" placeholder="Title" type="text" value="Tuiuiu site" />', html
        )
        ...
        self.assertInHTML(
            (
                ...
                ' type="url" value="http://www.tuiuiu.io" />'
            ),
            html
        )
    ...
    def test_searchable_content(self):
        ...
        self.assertEqual(content, ["Tuiuiu site"])
...
class TestListBlock(TuiuiuTestUtils, SimpleTestCase):
    ...
    def test_searchable_content(self):
        ...
        self.assertEqual(content, ["Tuiuiu", "Django"])
...
class TestStreamBlock(TuiuiuTestUtils, SimpleTestCase):
    def test_initialisation(self):
    ...
    def test_get_api_representation_calls_same_method_on_children_with_context(self):
        ...
        api_representation = block.get_api_representation(
            block.to_python([
                ...
                {'type': 'author', 'value': 'tuiuiu', 'id': '111111'},
            ]),
            context={
                'en': 'English',
                'tuiuiu': 'Tuiuiu!'
...
class TestPageChooserBlock(TestCase):
    ...
    def test_form_render(self):
        ...
        self.assertIn('createPageChooser("page", ["tuiuiucore.page"], null, false, null);', empty_form_html)
    ...
    def test_form_render_with_can_choose_root(self):
        ...
        empty_form_html = block.render_form(None, 'page')
        self.assertIn('createPageChooser("page", ["tuiuiucore.page"], null, true, null);', empty_form_html)
...
class TestSystemCheck(TestCase):
    def test_name_must_be_nonempty(self):
        ...
        self.assertEqual(errors[0].id, 'tuiuiucore.E001')
    ...
    def test_system_checks_recurse_into_structs(self):
        ...
        self.assertEqual(errors[1].id, 'tuiuiucore.E001')
