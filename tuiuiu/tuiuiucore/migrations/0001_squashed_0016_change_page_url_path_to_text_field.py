...
def initial_data(apps, schema_editor):
    ...
    homepage = Page.objects.create(
        title="Welcome to your new Tuiuiu site!",
        slug='home',
        content_type=page_content_type,
        path='00010001',
        depth=2,
...
def set_page_path_collation(apps, schema_editor):
    ...
    See: https://groups.google.com/d/msg/tuiuiu/q0leyuCnYWI/I9uDvVlyBAAJ
    """
    if schema_editor.connection.vendor == 'postgresql':
        schema_editor.execute("""
            ALTER TABLE tuiuiucore_page ALTER COLUMN path TYPE VARCHAR(255) COLLATE "C"
        """)
...
class Migration(migrations.Migration):
    ...
    replaces = [
        ('tuiuiucore', '0001_initial'),
        ('tuiuiucore', '0002_initial_data'),
        ('tuiuiucore', '0003_add_uniqueness_constraint_on_group_page_permission'),
        ('tuiuiucore', '0004_page_locked'),
        ('tuiuiucore', '0005_add_page_lock_permission_to_moderators'),
        ('tuiuiucore', '0006_add_lock_page_permission'),
        ('tuiuiucore', '0007_page_latest_revision_created_at'),
        ('tuiuiucore', '0008_populate_latest_revision_created_at'),
        ('tuiuiucore', '0009_remove_auto_now_add_from_pagerevision_created_at'),
        ('tuiuiucore', '0010_change_page_owner_to_null_on_delete'),
        ('tuiuiucore', '0011_page_first_published_at'),
        ('tuiuiucore', '0012_extend_page_slug_field'),
        ('tuiuiucore', '0013_update_golive_expire_help_text'),
        ('tuiuiucore', '0014_add_verbose_name'),
        ('tuiuiucore', '0015_add_more_verbose_names'),
        ('tuiuiucore', '0016_change_page_url_path_to_text_field')
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Page', related_name='revisions', to='tuiuiucore.Page')),
