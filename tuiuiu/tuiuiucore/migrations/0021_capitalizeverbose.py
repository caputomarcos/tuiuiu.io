...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tuiuiucore', '0020_add_index_on_page_first_published_at'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='grouppagepermission',
            name='page',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='group_permissions', to='tuiuiucore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='grouppagepermission',
        ...
        migrations.AlterField(
            model_name='pagerevision',
            name='page',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='revisions', to='tuiuiucore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='pagerevision',
        ...
        migrations.AlterField(
            ...
            name='page',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='view_restrictions', to='tuiuiucore.Page', verbose_name='page'),
        ),
        migrations.AlterField(
            model_name='pageviewrestriction',
            name='password',
        ...
        migrations.AlterField(
            model_name='site',
            name='root_page',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='sites_rooted_here', to='tuiuiucore.Page', verbose_name='root page'),
        ),
    ]
