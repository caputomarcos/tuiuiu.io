...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tuiuiucore', '0038_make_first_published_at_editable'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='view_restrictions', to='tuiuiucore.Collection', verbose_name='collection')),
