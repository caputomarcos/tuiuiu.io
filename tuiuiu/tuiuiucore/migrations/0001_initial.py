    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=models.CASCADE, to='tuiuiucore.Page', related_name='revisions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=models.CASCADE, to='tuiuiucore.Page', related_name='view_restrictions')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('root_page', models.ForeignKey(on_delete=models.CASCADE, to='tuiuiucore.Page', related_name='sites_rooted_here')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='page',
            field=models.ForeignKey(on_delete=models.CASCADE, to='tuiuiucore.Page', related_name='group_permissions'),
