...
class ListBlock(Block):
    ...
    @property
    def media(self):
        return forms.Media(js=[static('tuiuiuadmin/js/blocks/sequence.js'), static('tuiuiuadmin/js/blocks/list.js')])
    ...
    def render_list_member(self, value, prefix, index, errors=None):
        ...
        return render_to_string('tuiuiuadmin/block_forms/list_member.html', {
            'prefix': prefix,
            'child': child,
            'index': index,
        })
    ...
    def render_form(self, value, prefix='', errors=None):
        ...
        return render_to_string('tuiuiuadmin/block_forms/list.html', {
...
DECONSTRUCT_ALIASES = {
    ListBlock: 'tuiuiu.tuiuiucore.blocks.ListBlock',
}
