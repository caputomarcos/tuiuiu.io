...
from tuiuiu.tuiuiucore.utils import escape_script
...
class BaseStreamBlock(Block):
    ...
    def render_list_member(self, block_type_name, value, prefix, index, errors=None, id=None):
        ...
        return render_to_string('tuiuiuadmin/block_forms/stream_member.html', {
    ...
    @property
    def media(self):
        return forms.Media(js=[static('tuiuiuadmin/js/blocks/sequence.js'), static('tuiuiuadmin/js/blocks/stream.js')])
    ...
    def render_form(self, value, prefix='', errors=None):
        ...
        return render_to_string('tuiuiuadmin/block_forms/stream.html', {
            'prefix': prefix,
    ...
    def deconstruct(self):
        ...
        """
        path = 'tuiuiu.tuiuiucore.blocks.StreamBlock'
