...
class FieldBlock(Block):
    ...
    def render_form(self, value, prefix='', errors=None):
        ...
        return render_to_string('tuiuiuadmin/block_forms/field.html', {
            'name': self.name,
...
class TextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from tuiuiu.tuiuiuadmin.widgets import AdminAutoHeightTextInput
...
class DateBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from tuiuiu.tuiuiuadmin.widgets import AdminDateInput
        field_kwargs = {
...
class TimeBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from tuiuiu.tuiuiuadmin.widgets import AdminTimeInput
...
class DateTimeBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from tuiuiu.tuiuiuadmin.widgets import AdminDateTimeInput
        field_kwargs = {
...
class ChoiceBlock(FieldBlock):
    ...
    def deconstruct(self):
        ...
        """
        return ('tuiuiu.tuiuiucore.blocks.ChoiceBlock', [], self._constructor_kwargs)
...
class RichTextBlock(FieldBlock):
    ...
    @cached_property
    def field(self):
        from tuiuiu.tuiuiuadmin.rich_text import get_rich_text_editor_widget
...
# Ensure that the blocks defined here get deconstructed as tuiuiucore.blocks.FooBlock
# rather than tuiuiucore.blocks.field.FooBlock
block_classes = [
...
DECONSTRUCT_ALIASES = {
    cls: 'tuiuiu.tuiuiucore.blocks.%s' % cls.__name__
