...
class BaseStructBlock(Block):
    ...
    @property
    def media(self):
        return forms.Media(js=[static('tuiuiuadmin/js/blocks/struct.js')])
    ...
    def deconstruct(self):
        ...
        """
        path = 'tuiuiu.tuiuiucore.blocks.StructBlock'
    ...
    class Meta:
        ...
        form_template = 'tuiuiuadmin/block_forms/struct.html'
