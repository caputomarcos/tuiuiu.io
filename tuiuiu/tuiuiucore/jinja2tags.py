...
from .templatetags.tuiuiucore_tags import pageurl, richtext, slugurl, tuiuiu_version


class TuiuiuCoreExtension(Extension):
    tags = {'include_block'}

    def __init__(self, environment):
        super(TuiuiuCoreExtension, self).__init__(environment)

        self.environment.globals.update({
            'pageurl': jinja2.contextfunction(pageurl),
            'slugurl': jinja2.contextfunction(slugurl),
            'tuiuiu_version': tuiuiu_version,
        })
