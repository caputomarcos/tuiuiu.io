...
class TenantSyncRouter(object):
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        from tuiuiu.tuiuiutenant.utils import get_public_schema_name, app_labels
        from tuiuiu.tuiuiutenant.postgresql_backend.base import DatabaseWrapper as TenantDbWrapper

        db_engine = settings.DATABASES[db]['ENGINE']
        if not (db_engine == 'tuiuiutenant.postgresql_backend' or
