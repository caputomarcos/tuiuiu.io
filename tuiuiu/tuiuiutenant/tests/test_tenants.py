...
from tuiuiu.tuiuiutenant.test.cases import TenantTestCase
from tuiuiu.tuiuiutenant.tests.models import Tenant, NonAutoSyncTenant
from tuiuiu.tuiuiutenant.tests.testcases import BaseTestCase
from tuiuiu.tuiuiutenant.utils import tenant_context, schema_context, schema_exists, get_tenant_model, get_public_schema_name
...
class TenantDataAndSettingsTest(BaseTestCase):
    ...
    def setUpClass(cls):
        ...
        settings.SHARED_APPS = ('tuiuiutenant', )
...
class TenantSyncTest(BaseTestCase):
    ...
    def test_shared_apps_does_not_sync_tenant_apps(self):
        ...
        the a tenant schema.
        """
        settings.SHARED_APPS = ('tuiuiutenant',  # 2 tables
