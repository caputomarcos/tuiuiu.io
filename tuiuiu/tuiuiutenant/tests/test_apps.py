...
from tuiuiu.tuiuiutenant.apps import best_practice
from tuiuiu.tuiuiutenant.utils import get_tenant_model
...
class AppConfigTests(TestCase):
    ...
    def test_database_routers(self):
        self.assertBestPractice([
            Critical("DATABASE_ROUTERS setting must contain "
                     "'tuiuiutenant.routers.TenantSyncRouter'."),
        ])
    ...
    def test_tenant_schemas_before_django_installed_apps(self):
        self.assertBestPractice([
            Warning("You should put 'tuiuiutenant' before any django "
