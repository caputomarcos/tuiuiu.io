...
class TestSiteIndexView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)

    def get(self, params={}):
        return self.client.get(reverse('tuiuiusites:index'), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusites/index.html')
...
class TestSiteCreateView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)
    ...
    def get(self, params={}):
        return self.client.get(reverse('tuiuiusites:add'), params)

    def post(self, post_data={}):
        return self.client.post(reverse('tuiuiusites:add'), post_data)
    ...
    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusites/create.html')
    ...
    def test_create(self):
        ...
        self.assertRedirects(response, reverse('tuiuiusites:index'))
...
class TestSiteEditView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)
        self.localhost = Site.objects.all()[0]
    ...
    def get(self, params={}, site_id=None):
        return self.client.get(reverse('tuiuiusites:edit', args=(site_id or self.localhost.id, )), params)
    ...
    def post(self, post_data={}, site_id=None):
        ...
        if 'default' in post_data:
            ...
            post_data['is_default_site'] = 'on'
        return self.client.post(reverse('tuiuiusites:edit', args=(site_id,)), post_data)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusites/edit.html')
...
class TestSiteDeleteView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
        self.home_page = Page.objects.get(id=2)
        self.localhost = Site.objects.all()[0]
    ...
    def get(self, params={}, site_id=None):
        return self.client.get(reverse('tuiuiusites:delete', args=(site_id or self.localhost.id, )), params)

    def post(self, post_data={}, site_id=None):
        return self.client.post(reverse('tuiuiusites:delete', args=(site_id or self.localhost.id, )), post_data)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/generic/confirm_delete.html')
...
class TestLimitedPermissions(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a user
    ...
    def test_get_index(self):
        response = self.client.get(reverse('tuiuiusites:index'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusites/index.html')

    def test_get_create_view(self):
        response = self.client.get(reverse('tuiuiusites:add'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiusites/create.html')

    def test_create(self):
        response = self.client.post(reverse('tuiuiusites:add'), {
            'hostname': "testsite",
            'port': "80",
            'root_page': str(self.home_page.id),
        })
    ...
    def test_get_edit_view(self):
        edit_url = reverse('tuiuiusites:edit', args=(self.localhost.id,))
    ...
    def test_get_delete_view(self):
        delete_url = reverse('tuiuiusites:delete', args=(self.localhost.id,))
