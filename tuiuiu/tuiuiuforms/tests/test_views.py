...
from tuiuiu.tuiuiuadmin.edit_handlers import get_form_for_model
...
from tuiuiu.tuiuiuforms.models import FormSubmission
from tuiuiu.tuiuiuforms.tests.utils import make_form_page, make_form_page_with_custom_submission
...
class TestFormResponsesPanel(TestCase):
    def setUp(self):
        ...
        self.FormPageForm = get_form_for_model(
            FormPage, form_class=TuiuiuAdminPageForm
        )
    ...
    def test_render_with_submissions(self):
        ...
        url = reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,))
...
class TestFormsIndex(TestCase, TuiuiuTestUtils):
    fixtures = ['test.json']
    ...
    def test_forms_index(self):
        response = self.client.get(reverse('tuiuiuforms:index'))

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuforms/index.html')
    ...
    def test_forms_index_pagination(self):
        ...
        # Get page two
        response = self.client.get(reverse('tuiuiuforms:index'), {'p': 2})
    ...
    def test_forms_index_pagination_invalid(self):
        ...
        # Get page two
        response = self.client.get(reverse('tuiuiuforms:index'), {'p': 'Hello world!'})
    ...
    def test_forms_index_pagination_out_of_range(self):
        ...
        # Get page two
        response = self.client.get(reverse('tuiuiuforms:index'), {'p': 99999})
...
class TestFormsSubmissionsList(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a form page
        self.form_page = make_form_page()
    ...
    def test_list_submissions(self):
        response = self.client.get(reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,)))

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuforms/index_submissions.html')
    ...
    def test_list_submissions_filtering_date_from(self):
        response = self.client.get(
            reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,)), {'date_from': '01/01/2014'}
        )
    ...
    def test_list_submissions_filtering_date_to(self):
        response = self.client.get(
            reverse('tuiuiuforms:list_submissions', args=(self.form_page.id, )), {'date_to': '12/31/2013'}
        )
    ...
    def test_list_submissions_filtering_range(self):
        response = self.client.get(
            reverse('tuiuiuforms:list_submissions', args=(self.form_page.id, )),
    ...
    def test_list_submissions_pagination(self):
        ...
        response = self.client.get(reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,)), {'p': 2})
    ...
    def test_list_submissions_pagination_invalid(self):
        ...
        response = self.client.get(
            reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,)), {'p': 'Hello World!'}
        )
    ...
    def test_list_submissions_pagination_out_of_range(self):
        ...
        response = self.client.get(reverse('tuiuiuforms:list_submissions', args=(self.form_page.id,)), {'p': 99999})
...
class TestFormsSubmissionsExport(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a form page
        self.form_page = make_form_page()
...
class TestCustomFormsSubmissionsExport(TestCase, TuiuiuTestUtils):
...
class TestCustomFormsSubmissionsList(TestCase, TuiuiuTestUtils):
    def create_test_user_without_admin(self, username):
        return get_user_model().objects.create_user(username=username, password='123')
...
class TestDeleteFormSubmission(TestCase, TuiuiuTestUtils):
    fixtures = ['test.json']
    ...
    def test_delete_submission_show_confirmation(self):
        response = self.client.get(reverse(
            'tuiuiuforms:delete_submissions',
        ...
        self.assertTemplateUsed(response, 'tuiuiuforms/confirm_delete.html')
    ...
    def test_delete_submission_with_permissions(self):
        ...
        self.assertRedirects(response, reverse("tuiuiuforms:list_submissions", args=(self.form_page.id,)))
...
class TestIssue585(TestCase):
    ...
    def test_adding_duplicate_form_labels(self):
        ...
        response = self.client.post(
            reverse('tuiuiuadmin_pages:add', args=('tests', 'formpage', self.root_page.id)), post_data
        )
