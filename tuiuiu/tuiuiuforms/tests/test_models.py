...
from tuiuiu.tests.testapp.models import CustomFormPageSubmission, FormField, JadeFormPage
...
class TestFormWithCustomSubmission(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a form page
...
class TestFormSubmissionWithMultipleRecipientsAndWithCustomSubmission(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a form page
        self.form_page = make_form_page_with_custom_submission(
