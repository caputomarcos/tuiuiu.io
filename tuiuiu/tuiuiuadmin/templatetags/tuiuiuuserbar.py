...
from tuiuiu.tuiuiucore.models import PAGE_TEMPLATE_VAR, Page, PageRevision
...
def tuiuiuuserbar(context, position='bottom-right'):
    # Find request object
    try:
    ...
    if not user.has_perm('tuiuiuadmin.access_admin'):
        return ''
    ...
    return render_to_string('tuiuiuadmin/userbar/base.html', {
        'request': request,
