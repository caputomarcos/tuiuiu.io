...
from tuiuiu.tuiuiuadmin.forms import CollectionViewRestrictionForm
from tuiuiu.tuiuiuadmin.modal_workflow import render_modal_workflow
from tuiuiu.tuiuiucore.models import Collection, CollectionViewRestriction
...
def set_privacy(request, collection_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid() and not restriction_exists_on_ancestor:
            ...
            return render_modal_workflow(
                request, None, 'tuiuiuadmin/collection_privacy/set_privacy_done.js', {
    ...
    if restriction_exists_on_ancestor:
        ...
        return render_modal_workflow(
            request, 'tuiuiuadmin/collection_privacy/ancestor_privacy.html', None,
            {
        ...
        return render_modal_workflow(
            request,
            'tuiuiuadmin/collection_privacy/set_privacy.html',
            'tuiuiuadmin/collection_privacy/set_privacy.js', {
