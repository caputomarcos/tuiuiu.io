...
from tuiuiu.tuiuiuadmin.forms import EmailLinkChooserForm, ExternalLinkChooserForm, SearchForm
...
def browse(request, parent_page_id=None):
    ...
    return render_modal_workflow(
        request,
        'tuiuiuadmin/chooser/browse.html', 'tuiuiuadmin/chooser/browse.js',
        shared_context(request, {
            ...
            'page_types_restricted': (page_type_string != 'tuiuiucore.page')
        })
    )
...
def external_link(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render_modal_workflow(
                request,
                None, 'tuiuiuadmin/chooser/external_link_chosen.js',
                {
    ...
    return render_modal_workflow(
        request,
        'tuiuiuadmin/chooser/external_link.html', 'tuiuiuadmin/chooser/external_link.js',
        shared_context(request, {
            'form': form,
        })
    )
...
def email_link(request):
    ...
    return render_modal_workflow(
        request,
        'tuiuiuadmin/chooser/email_link.html', 'tuiuiuadmin/chooser/email_link.js',
        shared_context(request, {
            'form': form,
        })
    )
