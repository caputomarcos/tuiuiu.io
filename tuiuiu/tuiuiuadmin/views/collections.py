...
from tuiuiu.tuiuiuadmin.forms import CollectionForm
from tuiuiu.tuiuiuadmin.views.generic import CreateView, DeleteView, EditView, IndexView
...
class Index(IndexView):
    ...
    template_name = 'tuiuiuadmin/collections/index.html'
    add_url_name = 'tuiuiuadmin_collections:add'
...
class Create(CreateView):
    ...
    add_url_name = 'tuiuiuadmin_collections:add'
    edit_url_name = 'tuiuiuadmin_collections:edit'
    index_url_name = 'tuiuiuadmin_collections:index'
    header_icon = 'folder-open-1'
...
class Edit(EditView):
    ...
    model = Collection
    form_class = CollectionForm
    template_name = 'tuiuiuadmin/collections/edit.html'
    ...
    edit_url_name = 'tuiuiuadmin_collections:edit'
    index_url_name = 'tuiuiuadmin_collections:index'
    delete_url_name = 'tuiuiuadmin_collections:delete'
...
class Delete(DeleteView):
    ...
    def get_context(self):
        ...
        if collection_contents:
            ...
            self.template_name = 'tuiuiuadmin/collections/delete_not_empty.html'
