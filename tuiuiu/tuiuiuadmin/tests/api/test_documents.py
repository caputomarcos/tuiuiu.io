...
from tuiuiu.api.v2.tests.test_documents import TestDocumentDetail, TestDocumentListing
...
class TestAdminDocumentListing(AdminAPITestCase, TestDocumentListing):
    ...
    def get_response(self, **params):
        return self.client.get(reverse('tuiuiuadmin_api_v1:documents:listing'), params)
...
class TestAdminDocumentDetail(AdminAPITestCase, TestDocumentDetail):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(reverse('tuiuiuadmin_api_v1:documents:detail', args=(image_id, )), params)
