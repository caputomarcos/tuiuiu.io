...
from tuiuiu.api.v2.tests.test_images import TestImageDetail, TestImageListing
...
class TestAdminImageListing(AdminAPITestCase, TestImageListing):
    ...
    def get_response(self, **params):
        return self.client.get(reverse('tuiuiuadmin_api_v1:images:listing'), params)
...
class TestAdminImageDetail(AdminAPITestCase, TestImageDetail):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(reverse('tuiuiuadmin_api_v1:images:detail', args=(image_id, )), params)
