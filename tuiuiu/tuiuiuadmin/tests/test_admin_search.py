...
class BaseSearchAreaTestCase(TuiuiuTestUtils, TestCase):
    rf = RequestFactory()
    ...
    def search_other(self, current_url='/admin/', data=None):
        ...
        template = Template("{% load tuiuiuadmin_tags %}{% search_other %}")
    ...
    def menu_search(self, current_url='/admin/', data=None):
        ...
        request.user = self.user
        request.site = Site.objects.get()
        template = Template("{% load tuiuiuadmin_tags %}{% menu_search %}")
        return template.render(Context({'request': request}))
...
class TestSearchAreas(BaseSearchAreaTestCase):
    ...
    def test_other_searches(self):
        search_url = reverse('tuiuiuadmin_pages:search')
        query = "Hello"
        ...
        self.assertTemplateUsed(response, 'tuiuiuadmin/shared/search_area.html')
        self.assertTemplateUsed(response, 'tuiuiuadmin/shared/search_other.html')
    ...
    def test_menu_search(self):
        ...
        self.assertIn(reverse('tuiuiuadmin_pages:search'), rendered)
...
class TestSearchAreaNoPagePermissions(BaseSearchAreaTestCase):
    ...
    def test_dashboard(self):
        ...
        self.assertNotContains(response, reverse('tuiuiuadmin_pages:search'))
    ...
    def test_menu_search(self):
        ...
        """
        rendered = self.menu_search()
        self.assertNotIn(reverse('tuiuiuadmin_pages:search'), rendered)
