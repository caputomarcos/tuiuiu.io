...
from tuiuiu.tests.testapp.models import SimplePage
from tuiuiu.tests.utils import TuiuiuTestUtils
from tuiuiu.tuiuiucore.models import Page, PageViewRestriction


class TestSetPrivacyView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_get_public(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:set_privacy', args=(self.public_page.id, )))

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/page_privacy/set_privacy.html')
    ...
    def test_get_private(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:set_privacy', args=(self.private_page.id, )))
    ...
    def test_get_private_child(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:set_privacy', args=(self.private_child_page.id, )))

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/page_privacy/ancestor_privacy.html')
    ...
    def test_set_password_restriction(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_pages:set_privacy', args=(self.public_page.id, )), post_data)
    ...
    def test_unset_password_restriction(self):
        ...
        response = self.client.post(
            reverse('tuiuiuadmin_pages:set_privacy', args=(self.private_page.id, )), post_data)
    ...
    def test_get_private_groups(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:set_privacy', args=(self.private_groups_page.id, )))
    ...
    def test_unset_group_restriction(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_pages:set_privacy', args=(self.private_page.id, )), post_data)
...
class TestPrivacyIndicators(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_explorer_public(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_explore', args=(self.public_page.id, )))

        # Check the response
        self.assertEqual(response.status_code, 200)

        # Check the privacy indicator is public
        self.assertTemplateUsed(response, 'tuiuiuadmin/pages/_privacy_switch.html')
    ...
    def test_explorer_private(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_explore', args=(self.private_page.id, )))
    ...
    def test_explorer_private_child(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_explore', args=(self.private_child_page.id, )))
    ...
    def test_explorer_list_homepage(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_explore', args=(self.homepage.id, )))
    ...
    def test_edit_public(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:edit', args=(self.public_page.id, )))
    ...
    def test_edit_private(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:edit', args=(self.private_page.id, )))
    ...
    def test_edit_private_child(self):
        ...
        """
        response = self.client.get(reverse('tuiuiuadmin_pages:edit', args=(self.private_child_page.id, )))
