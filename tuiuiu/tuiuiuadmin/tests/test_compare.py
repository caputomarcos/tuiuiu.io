...
from tuiuiu.tuiuiuadmin import compare
...
class TestTagsFieldComparison(TestCase):
    ...
    def test_hasnt_changed(self):
        ...
        self.assertEqual(comparison.htmldiff(), 'tuiuiu, bird')
        self.assertIsInstance(comparison.htmldiff(), SafeText)
        self.assertFalse(comparison.has_changed())
    ...
    def test_has_changed(self):
        ...
        self.assertEqual(comparison.htmldiff(), 'tuiuiu, <span class="deletion">bird</span>, <span class="addition">motacilla</span>')
        self.assertIsInstance(comparison.htmldiff(), SafeText)
        self.assertTrue(comparison.has_changed())
