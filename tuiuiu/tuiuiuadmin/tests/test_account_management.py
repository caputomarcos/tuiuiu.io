...
from tuiuiu.tuiuiuadmin.utils import (
    TUIUIUADMIN_PROVIDED_LANGUAGES, get_available_admin_languages)
from tuiuiu.tuiuiuusers.models import UserProfile


class TestAuthentication(TestCase, TuiuiuTestUtils):
    """
    ...
    def test_login_view(self):
        ...
        self.assertTemplateUsed(response, 'tuiuiuadmin/login.html')
    ...
    def test_login_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_login'), {
            'username': 'test',
            'password': 'password',

            # NOTE: This is set using a hidden field in reality
            'next': reverse('tuiuiuadmin_home'),
        })
    ...
    def test_logout(self):
        ...
        # Get logout page
        response = self.client.get(reverse('tuiuiuadmin_logout'))

        # Check that the user was redirected to the login page
        self.assertRedirects(response, reverse('tuiuiuadmin_login'))
    ...
    def test_not_logged_in_redirect(self):
        ...
        self.assertRedirects(response, reverse('tuiuiuadmin_login') + '?next=' + reverse('tuiuiuadmin_home'))
    ...
    def test_not_logged_in_gives_403_to_ajax_requests(self):
        ...
        """
        # Get dashboard
        response = self.client.get(reverse('tuiuiuadmin_home'), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_not_logged_in_redirect_default_settings(self):
        ...
        # this must be the same URL as 'tuiuiuadmin_login'
    ...
    def test_logged_in_no_permission_redirect(self):
        ...
        # Get dashboard
        response = self.client.get(reverse('tuiuiuadmin_home'), follow=True)
...
class TestAccountSection(TestCase, TuiuiuTestUtils):
    """
    ...
    def test_account_view(self):
        ...
        """
        # Get account page
        response = self.client.get(reverse('tuiuiuadmin_account'))

        # Check that the user received an account page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/account.html')
        # Page should contain a 'Change password' option
        self.assertContains(response, "Change password")

    @override_settings(TUIUIU_PASSWORD_MANAGEMENT_ENABLED=False)
    ...
    def test_change_password_view(self):
        ...
        response = self.client.get(reverse('tuiuiuadmin_account_change_password'))

        # Check that the user received a change password page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/change_password.html')

    @override_settings(TUIUIU_PASSWORD_MANAGEMENT_ENABLED=False)
    def test_change_password_view_disabled(self):
        """
        This tests that the change password view responds with a 404
        when setting TUIUIU_PASSWORD_MANAGEMENT_ENABLED is False
        """
        # Get change password page
        response = self.client.get(reverse('tuiuiuadmin_account_change_password'))
    ...
    def test_change_password_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_account_change_password'), post_data)

        # Check that the user was redirected to the account page
        self.assertRedirects(response, reverse('tuiuiuadmin_account'))
    ...
    def test_notification_preferences_view(self):
        ...
        response = self.client.get(reverse('tuiuiuadmin_account_notification_preferences'))

        # Check that the user received a notification preferences page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/notification_preferences.html')
    ...
    def test_notification_preferences_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_account_notification_preferences'), post_data)
    ...
    def test_language_preferences_view(self):
        ...
        """
        # Get account page
        response = self.client.get(reverse('tuiuiuadmin_account_language_preferences'))

        # Check that the user received an account page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/language_preferences.html')
    ...
    def test_language_preferences_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_account_language_preferences'), post_data)
    ...
    @override_settings(TUIUIUADMIN_PERMITTED_LANGUAGES=[('en', 'English'), ('es', 'Spanish')])
    ...
    def test_available_admin_languages_by_default(self):
        self.assertListEqual(get_available_admin_languages(), TUIUIUADMIN_PROVIDED_LANGUAGES)

    @override_settings(TUIUIUADMIN_PERMITTED_LANGUAGES=[('en', 'English')])
    def test_not_show_options_if_only_one_language_is_permitted(self):
        response = self.client.post(reverse('tuiuiuadmin_account'))
        self.assertNotContains(response, 'Language Preferences')


class TestAccountManagementForNonModerator(TestCase, TuiuiuTestUtils):
    """
...
class TestAccountManagementForAdminOnlyUser(TestCase, TuiuiuTestUtils):
    """
    ...
    def test_notification_preferences_link_not_shown_for_admin_only_users(self):
        ...
        self.assertNotContains(response, reverse('tuiuiuadmin_account_notification_preferences'))
        # safety check that checking for absence/presence of urls works
        self.assertContains(response, reverse('tuiuiuadmin_home'))


class TestPasswordReset(TestCase, TuiuiuTestUtils):
    """
    ...
    def test_password_reset_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/password_reset/form.html')
    ...
    def test_password_reset_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_password_reset'), post_data)

        # Check that the user was redirected to the done page
        self.assertRedirects(response, reverse('tuiuiuadmin_password_reset_done'))
    ...
    def test_password_reset_confirm_view(self):
        ...
        response = self.client.get(reverse('tuiuiuadmin_password_reset_confirm', kwargs=self.url_kwargs))

        # Check that the user received a password confirm done page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/password_reset/confirm.html')
    ...
    def test_password_reset_confirm_view_post(self):
        ...
        response = self.client.post(reverse('tuiuiuadmin_password_reset_confirm', kwargs=self.url_kwargs), post_data)

        # Check that the user was redirected to the complete page
        self.assertRedirects(response, reverse('tuiuiuadmin_password_reset_complete'))
    ...
    def test_password_reset_done_view(self):
        ...
        response = self.client.get(reverse('tuiuiuadmin_password_reset_done'))

        # Check that the user received a password reset done page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/password_reset/done.html')
    ...
    def test_password_reset_complete_view(self):
        ...
        response = self.client.get(reverse('tuiuiuadmin_password_reset_complete'))

        # Check that the user received a password reset complete page
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuadmin/account/password_reset/complete.html')
