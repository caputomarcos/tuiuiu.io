...
class BaseItem(object):
    template = 'tuiuiuadmin/userbar/item_base.html'
...
class AdminItem(BaseItem):
    template = 'tuiuiuadmin/userbar/item_admin.html'

    def render(self, request):

        # Don't render if user doesn't have permission to access the admin area
        if not request.user.has_perm('tuiuiuadmin.access_admin'):
            return ""
...
class AddPageItem(BaseItem):
    template = 'tuiuiuadmin/userbar/item_page_add.html'
...
class ExplorePageItem(BaseItem):
    template = 'tuiuiuadmin/userbar/item_page_explore.html'
...
class EditPageItem(BaseItem):
    template = 'tuiuiuadmin/userbar/item_page_edit.html'
...
class ApproveModerationEditPageItem(ModeratePageItem):
    template = 'tuiuiuadmin/userbar/item_page_approve.html'


class RejectModerationEditPageItem(ModeratePageItem):
    template = 'tuiuiuadmin/userbar/item_page_reject.html'
