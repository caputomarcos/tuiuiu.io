...
from tuiuiu.utils.decorators import cached_classmethod
from tuiuiu.tuiuiuadmin import compare, widgets
from tuiuiu.tuiuiucore.fields import RichTextField
from tuiuiu.tuiuiucore.models import Page
from tuiuiu.tuiuiucore.utils import camelcase_to_underscore, resolve_model_string

# DIRECT_FORM_FIELD_OVERRIDES, FORM_FIELD_OVERRIDES are imported for backwards
# compatibility, as people are likely importing them from here and then
# appending their own overrides
from .forms import (  # NOQA
    DIRECT_FORM_FIELD_OVERRIDES, FORM_FIELD_OVERRIDES, TuiuiuAdminModelForm, TuiuiuAdminPageForm,
...
def get_form_for_model(
    model, form_class=TuiuiuAdminModelForm,
...
class BaseFormEditHandler(BaseCompositeEditHandler):
    ...
    def get_form_class(cls, model):
        ...
        if cls._form_class is None:
            ...
            # If that is not defined, use TuiuiuAdminModelForm.
            model_form_class = getattr(model, 'base_form_class', TuiuiuAdminModelForm)
...
class BaseTabbedInterface(BaseFormEditHandler):
    template = "tuiuiuadmin/edit_handlers/tabbed_interface.html"
...
class BaseObjectList(BaseFormEditHandler):
    template = "tuiuiuadmin/edit_handlers/object_list.html"
...
class BaseFieldRowPanel(BaseCompositeEditHandler):
    template = "tuiuiuadmin/edit_handlers/field_row_panel.html"
...
class BaseMultiFieldPanel(BaseCompositeEditHandler):
    template = "tuiuiuadmin/edit_handlers/multi_field_panel.html"
...
class BaseFieldPanel(EditHandler):
    ...
    object_template = "tuiuiuadmin/edit_handlers/single_field_panel.html"
    ...
    field_template = "tuiuiuadmin/edit_handlers/field_panel_field.html"
...
class BaseInlinePanel(EditHandler):
    ...
    template = "tuiuiuadmin/edit_handlers/inline_panel.html"
    ...
    js_template = "tuiuiuadmin/edit_handlers/inline_panel.js"
...
# Now that we've defined EditHandlers, we can set up tuiuiucore.Page to have some.
Page.content_panels = [
...
Page.base_form_class = TuiuiuAdminPageForm


@cached_classmethod
def get_edit_handler(cls):
    """
    Get the EditHandler to use in the Tuiuiu admin when editing this page type.
    """
