...
class MenuItem(with_metaclass(MediaDefiningClass)):
    template = 'tuiuiuadmin/shared/menu_item.html'
...
class SubmenuMenuItem(MenuItem):
    template = 'tuiuiuadmin/shared/menu_submenu_item.html'
    ...
    @property
    def media(self):
        return Media(js=[static('tuiuiuadmin/js/submenu.js')]) + self.menu.media
