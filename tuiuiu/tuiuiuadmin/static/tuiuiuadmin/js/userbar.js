...
document.addEventListener('DOMContentLoaded', function userBar(e) {
    var userbar = document.querySelector('[data-tuiuiu-userbar]');
    var trigger = userbar.querySelector('[data-tuiuiu-userbar-trigger]');
    var list = userbar.querySelector('.tuiuiu-userbar-items');
