...
from tuiuiu.tuiuiuadmin import widgets
...
class TuiuiuAdminModelFormMetaclass(ClusterFormMetaclass):
    ...
    def __new__(cls, name, bases, attrs):
        ...
        new_class = super(TuiuiuAdminModelFormMetaclass, cls).__new__(cls, name, bases, attrs)
        return new_class


class TuiuiuAdminModelForm(with_metaclass(TuiuiuAdminModelFormMetaclass, ClusterForm)):
    @property
    def media(self):
        # Include media from formsets forms. This allow StreamField in InlinePanel for example.
        media = super(TuiuiuAdminModelForm, self).media
        for formset in self.formsets.values():
            media += formset.media
        return media


# Now, any model forms built off TuiuiuAdminModelForm instead of ModelForm should pick up
# the nice form fields defined in FORM_FIELD_OVERRIDES.


class TuiuiuAdminPageForm(TuiuiuAdminModelForm):
    ...
    def __init__(self, data=None, files=None, parent_page=None, *args, **kwargs):
        super(TuiuiuAdminPageForm, self).__init__(data, files, *args, **kwargs)
