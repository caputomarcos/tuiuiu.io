...
class TestRedirectsIndexView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()

    def get(self, params={}):
        return self.client.get(reverse('tuiuiuredirects:index'), params)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuredirects/index.html')
...
class TestRedirectsAddView(TestCase, TuiuiuTestUtils):
    fixtures = ['test.json']
    ...
    def get(self, params={}):
        return self.client.get(reverse('tuiuiuredirects:add'), params)

    def post(self, post_data={}):
        return self.client.post(reverse('tuiuiuredirects:add'), post_data)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuredirects/add.html')
    ...
    def test_add(self):
        ...
        self.assertRedirects(response, reverse('tuiuiuredirects:index'))
...
class TestRedirectsEditView(TestCase, TuiuiuTestUtils):
    def setUp(self):
    ...
    def get(self, params={}, redirect_id=None):
        return self.client.get(reverse('tuiuiuredirects:edit', args=(redirect_id or self.redirect.id, )), params)

    def post(self, post_data={}, redirect_id=None):
        return self.client.post(reverse('tuiuiuredirects:edit', args=(redirect_id or self.redirect.id, )), post_data)

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuredirects/edit.html')
...
class TestRedirectsDeleteView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        # Create a redirect to edit
        self.redirect = models.Redirect(old_path='/test', redirect_link='http://www.test.com/')
        self.redirect.save()
    ...
    def get(self, params={}, redirect_id=None):
        return self.client.get(reverse('tuiuiuredirects:delete', args=(redirect_id or self.redirect.id, )), params)

    def post(self, redirect_id=None):
        return self.client.post(reverse(
            'tuiuiuredirects:delete', args=(redirect_id or self.redirect.id, )
        ))

    def test_simple(self):
        response = self.get()
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiuredirects/confirm_delete.html')
