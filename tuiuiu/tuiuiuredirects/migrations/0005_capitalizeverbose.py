...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tuiuiuredirects', '0004_set_unique_on_path_and_site'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='redirect',
            name='redirect_page',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, null=True, to='tuiuiucore.Page', verbose_name='redirect to a page'),
        ),
        migrations.AlterField(
            model_name='redirect',
            name='site',
            field=models.ForeignKey(on_delete=models.CASCADE, blank=True, related_name='redirects', null=True, to='tuiuiucore.Site', verbose_name='site'),
        ),
    ]
