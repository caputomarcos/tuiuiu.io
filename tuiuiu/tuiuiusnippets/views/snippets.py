...
from tuiuiu.tuiuiusnippets.permissions import get_permission_name, user_can_edit_snippet_type
...
def index(request):
    ...
    return render(request, 'tuiuiusnippets/snippets/index.html', {
...
def create(request, app_label, model_name):
            ...
            messages.success(
                ...
                buttons=[
                    messages.button(reverse(
                        'tuiuiusnippets:edit', args=(app_label, model_name, instance.id)
                    ), _('Edit'))
                ]
            )
    ...
    return render(request, 'tuiuiusnippets/snippets/create.html', {
        'model_opts': model._meta,
...
def edit(request, app_label, model_name, id):
    ...
    return render(request, 'tuiuiusnippets/snippets/edit.html', {
        'model_opts': model._meta,
        'instance': instance,
        'edit_handler': edit_handler,
        'form': form,
