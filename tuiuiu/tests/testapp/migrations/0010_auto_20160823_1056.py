    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thank_you_text', tuiuiu.tuiuiucore.fields.RichTextField(blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='custom_form_fields', to='tests.FormPageWithCustomSubmission'),
        ),
        migrations.AddField(
            model_name='customformpagesubmission',
            name='page',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tuiuiucore.Page'),
        ),
        migrations.AddField(
            model_name='customformpagesubmission',
            name='user',
