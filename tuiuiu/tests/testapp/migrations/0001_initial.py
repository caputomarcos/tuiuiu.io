...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tuiuiudocs', '0005_alter_uploaded_by_user_on_delete_action'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ImageField(height_field='height', upload_to=tuiuiu.tuiuiuimages.models.get_upload_to, verbose_name='file', width_field='width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='tuiuiuimages.Image')),
                ('link_document', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='tuiuiudocs.Document')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, to='tuiuiucore.Site')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='page',
            field=models.ForeignKey(help_text='help text', on_delete=django.db.models.deletion.CASCADE, to='tuiuiucore.Page'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='link_page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='tuiuiucore.Page'),
        ),
        migrations.AddField(
            model_name='eventpagespeaker',
            name='page',
        ...
        migrations.AddField(
            ...
            name='feed_image',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='tuiuiuimages.Image'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='advert_placements', to='tuiuiucore.Page'),
        ),
        migrations.AddField(
            model_name='advert',
            name='tags',
