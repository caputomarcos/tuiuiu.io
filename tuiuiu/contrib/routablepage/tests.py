...
from tuiuiu.contrib.routablepage.templatetags.routablepage_tags import \
    routablepageurl
from tuiuiu.tests.routablepage.models import RoutablePageTest, RoutablePageWithoutIndexRouteTest
