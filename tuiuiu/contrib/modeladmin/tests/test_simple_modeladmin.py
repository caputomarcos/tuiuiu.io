...
from tuiuiu.tests.modeladmintest.models import Author, Book, Publisher, Token
from tuiuiu.tests.utils import TuiuiuTestUtils
from tuiuiu.tuiuiuimages.models import Image
from tuiuiu.tuiuiuimages.tests.utils import get_test_image_file


class TestBookIndexView(TestCase, TuiuiuTestUtils):
...
class TestAuthorIndexView(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestCreateView(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
    ...
    def test_exclude_passed_to_extract_panel_definitions(self):
        path_to_form_fields_exclude_property = 'tuiuiu.contrib.modeladmin.options.ModelAdmin.form_fields_exclude'
        with mock.patch('tuiuiu.contrib.modeladmin.views.extract_panel_definitions_from_model_class') as m:
...
class TestInspectView(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestEditView(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestPageSpecificViews(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestConfirmDeleteView(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestDeleteViewWithProtectedRelation(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestDeleteViewModelReprPrimary(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
...
class TestQuoting(TestCase, TuiuiuTestUtils):
    fixtures = ['modeladmintest_test.json']
