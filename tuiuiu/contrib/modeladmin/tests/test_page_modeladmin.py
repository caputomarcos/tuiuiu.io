...
from tuiuiu.tests.testapp.models import BusinessIndex, EventCategory, EventPage
from tuiuiu.tests.utils import TuiuiuTestUtils
from tuiuiu.tuiuiucore.models import GroupPagePermission, Page


class TestIndexView(TestCase, TuiuiuTestUtils):
...
class TestExcludeFromExplorer(TestCase, TuiuiuTestUtils):
...
class TestDeleteView(TestCase, TuiuiuTestUtils):
    fixtures = ['test_specific.json']
...
class TestChooseParentView(TestCase, TuiuiuTestUtils):
    fixtures = ['test_specific.json']
...
class TestChooseParentViewForNonSuperuser(TestCase, TuiuiuTestUtils):
    fixtures = ['test_specific.json']
