...
class TuiuiuRegisterable(object):
    """
    Base class, providing a more convenient way for ModelAdmin or
    ModelAdminGroup instances to be registered with Tuiuiu's admin area.
    """
    add_to_settings_menu = False
    exclude_from_explorer = False

    def register_with_tuiuiu(self):
...
class ModelAdmin(TuiuiuRegisterable):
    """
    The core modeladmin class. It provides an alternative means to
    list and manage instances of a given 'model' within Tuiuiu's admin area.
    ...
    additional functionality available via various Tuiuiu hooks.
    """
    ...
    def get_index_view_extra_css(self):
        css = ['tuiuiumodeladmin/css/index.css']
    ...
    def create_view(self, request):
        ...
        the assigned model, or redirect to Tuiuiu's create view if the
    ...
    def choose_parent_view(self, request):
        ...
        for a new object, where the assigned model extends Tuiuiu's Page
    ...
    def edit_view(self, request, instance_pk):
        ...
        assigned model, or redirect to Tuiuiu's edit view if the assinged
    ...
    def delete_view(self, request, instance_pk):
        ...
        functionality for the assigned model, or redirect to Tuiuiu's delete
    ...
    def get_menu_item(self, order=None):
        """
        Utilised by Tuiuiu's 'register_menu_item' hook to create a menu item
    ...
    def get_permissions_for_registration(self):
        """
        Utilised by Tuiuiu's 'register_permissions' hook to allow permissions
        ...
        """
        from tuiuiu.tuiuiusnippets.models import SNIPPET_MODELS
    ...
    def get_admin_urls_for_registration(self):
        """
        Utilised by Tuiuiu's 'register_admin_urls' hook to register urls for
...
class ModelAdminGroup(TuiuiuRegisterable):
    """
    ...
    def get_menu_item(self):
        """
        Utilised by Tuiuiu's 'register_menu_item' hook to create a menu
...
def modeladmin_register(modeladmin_class):
    """
    Method for registering ModelAdmin or ModelAdminGroup classes with Tuiuiu.
    """
    instance = modeladmin_class()
    instance.register_with_tuiuiu()
