...
class InspectView(InstanceSpecificView):
    ...
    def get_field_display_value(self, field_name, field=None):
        ...
        # tuiuiu.tuiuiuimages might not be installed
        try:
            from tuiuiu.tuiuiuimages.models import AbstractImage
        ...
        # tuiuiu.tuiuiudocuments might not be installed
        try:
            from tuiuiu.tuiuiudocs.models import AbstractDocument
    ...
    def get_image_field_display(self, field_name, field):
        """ Render an image """
        from tuiuiu.tuiuiuimages.shortcuts import get_rendition_or_not_found
