...
from tuiuiu.tuiuiuadmin.menu import Menu, MenuItem, SubmenuMenuItem


class ModelAdminMenuItem(MenuItem):
    """
    A sub-class of tuiuiu's MenuItem, used by PageModelAdmin to add a link
    to its listing page
    """
...
class GroupMenuItem(SubmenuMenuItem):
    """
    A sub-class of tuiuiu's SubmenuMenuItem, used by ModelAdminGroup to add a
...
class SubMenu(Menu):
    """
    A sub-class of tuiuiu's Menu, used by AppModelAdmin. We just want to
