...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tuiuiusearch', '0003_remove_editors_pick'),
    ]
            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('page', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Page', to='tuiuiucore.Page')),
                        ('query', models.ForeignKey(on_delete=models.CASCADE, to='tuiuiusearch.Query', related_name='editors_picks')),
                    ],
                    options={
                        'db_table': 'tuiuiusearch_editorspick',
