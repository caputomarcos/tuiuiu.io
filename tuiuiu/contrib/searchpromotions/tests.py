...
from tuiuiu.contrib.searchpromotions.templatetags.searchpromotions_tags import \
...
class TestSearchPromotionsIndexView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_search(self):
        response = self.client.get(reverse('searchpromotions:index'), {'q': "Hello"})
        self.assertEqual(response.status_code, 200)
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse('searchpromotions:index'), {'p': 2})
    ...
    def test_pagination_invalid(self):
        ...
        response = self.client.get(reverse('searchpromotions:index'), {'p': 'Hello World!'})
    ...
    def test_pagination_out_of_range(self):
        ...
        response = self.client.get(reverse('searchpromotions:index'), {'p': 99999})
...
class TestSearchPromotionsAddView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse('searchpromotions:add'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'searchpromotions/add.html')
...
class TestSearchPromotionsEditView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(reverse('searchpromotions:edit', args=(self.query.id, )))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'searchpromotions/edit.html')
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse('searchpromotions:edit', args=(self.query.id, )), post_data)
...
class TestSearchPromotionsDeleteView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(reverse('searchpromotions:delete', args=(self.query.id, )))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'searchpromotions/confirm_delete.html')

    def test_post(self):
        # Submit
        response = self.client.post(reverse('searchpromotions:delete', args=(self.query.id, )))
