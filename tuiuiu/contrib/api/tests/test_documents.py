...
class TestDocumentListing(TestCase):
    ...
    def get_response(self, **params):
        return self.client.get(reverse('tuiuiuapi_v1:documents:listing'), params)
...
class TestDocumentDetail(TestCase):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(reverse('tuiuiuapi_v1:documents:detail', args=(image_id, )), params)
    ...
    def test_download_url_with_custom_base_url(self):
        ...
        self.assertIn('download_url', content['meta'])
        self.assertEqual(
            content['meta']['download_url'], 'http://api.example.com/documents/1/tuiuiu_by_markyharky.jpg'
        )
