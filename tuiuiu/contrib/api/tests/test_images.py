...
class TestImageListing(TestCase):
    ...
    def get_response(self, **params):
        return self.client.get(reverse('tuiuiuapi_v1:images:listing'), params)
...
class TestImageDetail(TestCase):
    ...
    def get_response(self, image_id, **params):
        return self.client.get(reverse('tuiuiuapi_v1:images:detail', args=(image_id, )), params)
    ...
    def test_basic(self):
        ...
        self.assertEqual(content['meta']['type'], 'tuiuiuimages.Image')
