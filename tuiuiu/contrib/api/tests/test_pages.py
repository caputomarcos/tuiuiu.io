...
from tuiuiu.contrib.api import signal_handlers
...
class TestPageListing(TestCase):
    ...
    def get_response(self, **params):
        return self.client.get(reverse('tuiuiuapi_v1:pages:listing'), params)
...
class TestPageDetail(TestCase):
    ...
    def get_response(self, page_id, **params):
        return self.client.get(reverse('tuiuiuapi_v1:pages:detail', args=(page_id, )), params)
...
class TestPageDetailWithStreamField(TestCase):
    ...
    def test_can_fetch_streamfield_content(self):
        ...
        response_url = reverse('tuiuiuapi_v1:pages:detail', args=(stream_page.id, ))
