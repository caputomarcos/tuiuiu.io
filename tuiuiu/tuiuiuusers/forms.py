...
# Custom fields
if hasattr(settings, 'TUIUIU_USER_CUSTOM_FIELDS'):
    custom_fields = set(settings.TUIUIU_USER_CUSTOM_FIELDS)
else:
    custom_fields = set()
...
class GroupForm(forms.ModelForm):
    ...
    def save(self):
        ...
        # accessible in the tuiuiu admin interface, as otherwise these would
...
class BaseGroupPagePermissionFormSet(forms.BaseFormSet):
    ...
    def as_admin_panel(self):
        return render_to_string('tuiuiuusers/groups/includes/page_permissions_formset.html', {
            'formset': self
        })
