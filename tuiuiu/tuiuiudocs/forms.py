...
from tuiuiu.tuiuiudocs.permissions import permission_policy as documents_permission_policy
...
GroupDocumentPermissionFormSet = collection_member_permission_formset_factory(
    ...
    'tuiuiudocs/permissions/includes/document_permissions_formset.html'
)
