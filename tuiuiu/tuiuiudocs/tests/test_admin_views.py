...
from tuiuiu.tests.testapp.models import EventPage, EventPageRelatedLink
from tuiuiu.tests.utils import TuiuiuTestUtils
from tuiuiu.tuiuiucore.models import Collection, GroupCollectionPermission, Page
from tuiuiu.tuiuiudocs import models


class TestDocumentIndexView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:index'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/documents/index.html')
        self.assertContains(response, "Add a document")

    def test_search(self):
        response = self.client.get(reverse('tuiuiudocs:index'), {'q': "Hello"})
        self.assertEqual(response.status_code, 200)
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:index'), {'p': 2})
    ...
    def test_pagination_invalid(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:index'), {'p': 'Hello World!'})
    ...
    def test_pagination_out_of_range(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:index'), {'p': 99999})
    ...
    def test_ordering(self):
        ...
        for ordering in orderings:
            response = self.client.get(reverse('tuiuiudocs:index'), {'ordering': ordering})
            self.assertEqual(response.status_code, 200)


class TestDocumentAddView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
...
class TestDocumentAddViewWithLimitedCollectionPermissions(TestCase, TuiuiuTestUtils):
    def setUp(self):
...
class TestDocumentEditView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:edit', args=(self.document.id,)))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/documents/edit.html')
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse('tuiuiudocs:edit', args=(self.document.id,)), post_data)
    ...
    def test_with_missing_source_file(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:edit', args=(document.id,)), {})
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/documents/edit.html')
...
class TestDocumentDeleteView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:delete', args=(self.document.id,)))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/documents/confirm_delete.html')

    def test_delete(self):
        # Submit title change
        response = self.client.post(reverse('tuiuiudocs:delete', args=(self.document.id,)))
...
class TestMultipleDocumentUploader(TestCase, TuiuiuTestUtils):
    """
    This tests the multiple document upload views located in tuiuiudocs/views/multiple.py
    """
    def setUp(self):
        self.login()
    ...
    def test_add_post(self):
        ...
        """
        response = self.client.post(reverse('tuiuiudocs:add_multiple'), {
    ...
    def test_add_post_nofile(self):
        ...
        """
        response = self.client.post(reverse('tuiuiudocs:add_multiple'), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_edit_get(self):
        ...
        """
        # Send request
        response = self.client.get(reverse('tuiuiudocs:edit_multiple', args=(self.doc.id, )))
    ...
    def test_edit_post(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('tuiuiudocs:edit_multiple', args=(self.doc.id, )), {
    ...
    def test_delete_get(self):
        ...
        """
        # Send request
        response = self.client.get(reverse('tuiuiudocs:delete_multiple', args=(self.doc.id, )))
    ...
    def test_delete_post(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('tuiuiudocs:delete_multiple', args=(self.doc.id, )), HTTP_X_REQUESTED_WITH='XMLHttpRequest')
    ...
    def test_delete_post_noajax(self):
        ...
        """
        # Send request
        response = self.client.post(reverse('tuiuiudocs:delete_multiple', args=(self.doc.id, )))

        # Check response
        self.assertEqual(response.status_code, 400)


class TestDocumentChooserView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.user = self.login()

    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:chooser'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/chooser/chooser.html')
        self.assertTemplateUsed(response, 'tuiuiudocs/chooser/chooser.js')

    def test_search(self):
        response = self.client.get(reverse('tuiuiudocs:chooser'), {'q': "Hello"})
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context['query_string'], "Hello")
    ...
    def test_pagination(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:chooser'), {'p': 2})

        # Check response
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/documents/list.html')
    ...
    def test_pagination_invalid(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:chooser'), {'p': 'Hello World!'})
    ...
    def test_pagination_out_of_range(self):
        ...
        response = self.client.get(reverse('tuiuiudocs:chooser'), {'p': 99999})
    ...
    def test_construct_queryset_hook_search(self):
        ...
        with self.register_hook('construct_document_chooser_queryset', filter_documents):
            response = self.client.get(reverse('tuiuiudocs:chooser'), {'q': 'Test'})
        self.assertEqual(len(response.context['documents']), 1)
        self.assertEqual(response.context['documents'][0], document)


class TestDocumentChooserChosenView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()
    ...
    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:document_chosen', args=(self.document.id,)))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/chooser/document_chosen.js')


class TestDocumentChooserUploadView(TestCase, TuiuiuTestUtils):
    def setUp(self):
        self.login()

    def test_simple(self):
        response = self.client.get(reverse('tuiuiudocs:chooser_upload'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'tuiuiudocs/chooser/chooser.html')
        self.assertTemplateUsed(response, 'tuiuiudocs/chooser/chooser.js')
    ...
    def test_post(self):
        ...
        response = self.client.post(reverse('tuiuiudocs:chooser_upload'), post_data)
...
class TestDocumentChooserUploadViewWithLimitedPermissions(TestCase, TuiuiuTestUtils):
    def setUp(self):
        add_doc_permission = Permission.objects.get(
            content_type__app_label='tuiuiudocs', codename='add_document'
        )
...
class TestUsageCount(TestCase, TuiuiuTestUtils):
    fixtures = ['test.json']
    ...
    def test_usage_count_does_not_appear(self):
        ...
        event_page_related_link.link_document = doc
        event_page_related_link.save()
        response = self.client.get(reverse('tuiuiudocs:edit',
                                           args=(1,)))
...
class TestGetUsage(TestCase, TuiuiuTestUtils):
    fixtures = ['test.json']
    ...
    def test_usage_page(self):
        ...
        event_page_related_link.link_document = doc
        event_page_related_link.save()
        response = self.client.get(reverse('tuiuiudocs:document_usage',
                                           args=(1,)))
...
class TestEditOnlyPermissions(TestCase, TuiuiuTestUtils):
    ...
    def test_post_edit(self):
        ...
        response = self.client.post(
            reverse('tuiuiudocs:edit', args=(self.document.id,)), {
                'title': "Test document changed!",
                'file': '',
            }
        )
