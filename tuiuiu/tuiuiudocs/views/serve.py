...
from tuiuiu.utils import sendfile_streaming_backend
from tuiuiu.utils.sendfile import sendfile
from tuiuiu.tuiuiucore import hooks
from tuiuiu.tuiuiucore.forms import PasswordViewRestrictionForm
from tuiuiu.tuiuiucore.models import CollectionViewRestriction
from tuiuiu.tuiuiudocs.models import document_served, get_document_model
...
def authenticate_with_password(request, restriction_id):
    ...
    action_url = reverse('tuiuiudocs_authenticate_with_password', args=[restriction.id])
