...
from tuiuiu.tuiuiuadmin.utils import PermissionPolicyChecker, popular_tags_for_model
...
from tuiuiu.tuiuiuimages.formats import get_image_format
from tuiuiu.tuiuiuimages.forms import ImageInsertionForm, get_image_form
...
def get_image_json(image):
    ...
    return json.dumps({
        'id': image.id,
        'edit_link': reverse('tuiuiuimages:edit', args=(image.id,)),
        'title': image.title,
        'preview': {
...
def chooser(request):
    ...
    if (
        ...
        return render(request, "tuiuiuimages/chooser/results.html", {
            'images': images,
        ...
        return render_modal_workflow(request, 'tuiuiuimages/chooser/chooser.html', 'tuiuiuimages/chooser/chooser.js', {
            'images': images,
...
def chooser_upload(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if request.GET.get('select_format'):
                ...
                return render_modal_workflow(
                    request, 'tuiuiuimages/chooser/select_format.html', 'tuiuiuimages/chooser/select_format.js',
    ...
    return render_modal_workflow(
        request, 'tuiuiuimages/chooser/chooser.html', 'tuiuiuimages/chooser/chooser.js',
