...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tuiuiuimages', '0008_image_created_at_index'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='file',
            field=models.ImageField(upload_to=tuiuiu.tuiuiuimages.models.get_upload_to, height_field='height', width_field='width', verbose_name='file'),
        ),
        migrations.AlterField(
            model_name='image',
            name='height',
