    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ImageField(
                    width_field='width', upload_to=tuiuiu.tuiuiuimages.models.get_upload_to,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter', models.ForeignKey(on_delete=models.CASCADE, related_name='+', to='tuiuiuimages.Filter')),
                ('image', models.ForeignKey(on_delete=models.CASCADE, related_name='renditions', to='tuiuiuimages.Image')),
            ],
            options={
            },
            bases=(models.Model,),
