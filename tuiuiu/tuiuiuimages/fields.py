...
class TuiuiuImageField(ImageField):
    def __init__(self, *args, **kwargs):
        super(TuiuiuImageField, self).__init__(*args, **kwargs)

        # Get max upload size from settings
        self.max_upload_size = getattr(settings, 'TUIUIUIMAGES_MAX_UPLOAD_SIZE', 10 * 1024 * 1024)
    ...
    def to_python(self, data):
        f = super(TuiuiuImageField, self).to_python(data)
