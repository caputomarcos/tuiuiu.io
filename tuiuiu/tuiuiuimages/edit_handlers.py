...
from tuiuiu.tuiuiuadmin.compare import ForeignObjectComparison
from tuiuiu.tuiuiuadmin.edit_handlers import BaseChooserPanel
...
class ImageFieldComparison(ForeignObjectComparison):
    def htmldiff(self):
        ...
        return render_to_string("tuiuiuimages/widgets/compare.html", {
            'image_a': image_a,
            'image_b': image_b,
        })
