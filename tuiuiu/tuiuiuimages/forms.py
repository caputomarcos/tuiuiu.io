...
from tuiuiu.tuiuiuadmin.forms import (
    BaseCollectionMemberForm, collection_member_permission_formset_factory)
from tuiuiu.tuiuiuimages.fields import TuiuiuImageField
from tuiuiu.tuiuiuimages.formats import get_image_formats
from tuiuiu.tuiuiuimages.models import Image
from tuiuiu.tuiuiuimages.permissions import permission_policy as images_permission_policy
...
def formfield_for_dbfield(db_field, **kwargs):
    ...
    if db_field.name == 'file':
        return TuiuiuImageField(label=capfirst(db_field.verbose_name), **kwargs)
...
GroupImagePermissionFormSet = collection_member_permission_formset_factory(
    ...
    'tuiuiuimages/permissions/includes/image_permissions_formset.html'
)
