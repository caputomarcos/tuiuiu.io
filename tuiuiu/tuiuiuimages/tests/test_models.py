...
from tuiuiu.tests.testapp.models import EventPage, EventPageCarouselItem
...
from tuiuiu.tuiuiuimages.models import Rendition, SourceImageIOError
from tuiuiu.tuiuiuimages.rect import Rect
...
class TestRenditions(TestCase):
    ...
    def test_minification(self):
        ...
        # via the Rendition.filter_spec attribute (in active use as of Tuiuiu 1.8)
...
class TestIssue613(TestCase, TuiuiuTestUtils):
    ...
    def add_image(self, **params):
        ...
        response = self.client.post(reverse('tuiuiuimages:add'), post_data)
    ...
    def edit_image(self, **params):
        ...
        post_data.update(params)
        response = self.client.post(reverse('tuiuiuimages:edit', args=(self.image.id,)), post_data)
