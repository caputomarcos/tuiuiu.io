...
from .filters import (
    ...
    SearchFilter)
from .pagination import TuiuiuPagination
...
class BaseAPIEndpoint(GenericViewSet):
    ...
    # Remove this check in Tuiuiu 1.4 as rest_framework will be required
    # RemovedInTuiuiu14Warning
    if apps.is_installed('rest_framework'):
        renderer_classes.append(BrowsableAPIRenderer)

    pagination_class = TuiuiuPagination
    ...
    def get_serializer_class(self):
        ...
        return self._get_serializer_class(self.request.tuiuiuapi_router, model, fields_config, show_details=show_details)
    ...
    def get_serializer_context(self):
        ...
        return {
            'request': self.request,
            'view': self,
            'router': self.request.tuiuiuapi_router
        }
...
class PagesAPIEndpoint(BaseAPIEndpoint):
    ...
    def get_queryset(self):
        ...
        try:
            models = page_models_from_string(request.GET.get('type', 'tuiuiucore.Page'))
