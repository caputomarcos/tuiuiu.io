...
1. (for example) Start a new project with `tuiuiu start myproject`
...
* Tuiuiu version: Hover over the Tuiuiu bird in the admin, or run `pip show tuiuiu | grep Version:`.
