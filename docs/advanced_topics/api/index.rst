...
non-web clients (such as a mobile phone app) or pulling content out of Tuiuiu
...
compatibility and will be removed from Tuiuiu soon.

See `RFC 8: Tuiuiu API <https://github.com/tuiuiu/rfcs/blob/master/accepted/008-tuiuiu-api.md#12---stable-and-unstable-versions>`_
