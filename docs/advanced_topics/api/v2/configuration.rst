==================================
Tuiuiu API v2 Configuration Guide
==================================
...
install this manually as it is already a dependency of Tuiuiu.
...
Firstly, you need to enable Tuiuiu's API app so Django can see it.
Add ``tuiuiu.api.v2`` to ``INSTALLED_APPS`` in your Django project settings:
...
Tuiuiu provides three endpoint classes you can use:

 - Pages :class:`tuiuiu.api.v2.endpoints.PagesAPIEndpoint`
 - Images :class:`tuiuiu.tuiuiuimages.api.v2.endpoints.ImagesAPIEndpoint`
 - Documents :class:`tuiuiu.tuiuiudocs.api.v2.endpoints.DocumentsAPIEndpoint`
...
content types to the API: :class:`tuiuiu.api.v2.endpoints.BaseAPIEndpoint`
...
.. code-block:: python
    ...
    # Create the router. "tuiuiuapi" is the URL namespace
    api_router = TuiuiuAPIRouter('tuiuiuapi')
...
.. code-block:: python
    ...
    urlpatterns = [
        ...
        # Ensure that the api_router line appears above the default Tuiuiu page serving route
...
.. code-block:: python
    ...
    from tuiuiu.api import APIField
...
The :class:`~tuiuiu.tuiuiuimages.api.fields.ImageRenditionField` serialiser
...
.. code-block:: python
    ...
    from tuiuiu.tuiuiuimages.api.fields.ImageRenditionField
...
must be set when using this module alongside the ``tuiuiufrontendcache`` module.

``TUIUIUAPI_SEARCH_ENABLED``
-----------------------------
