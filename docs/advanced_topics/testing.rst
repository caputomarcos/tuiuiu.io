...
=========================
Testing your Tuiuiu site
=========================

Tuiuiu comes with some utilities that simplify writing tests for your site.

.. automodule:: tuiuiu.tests.utils

TuiuiuPageTests
================

.. class:: TuiuiuPageTests

    ``TuiuiuPageTests`` extends ``django.test.TestCase``, adding a few new ``assert`` methods. You should extend this class to make use of its methods:

    .. code-block:: python

        from tuiuiu.tests.utils import TuiuiuPageTests
        from myapp.models import MyPage

        class MyPageTests(TuiuiuPageTests):
