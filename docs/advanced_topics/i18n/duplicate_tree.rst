...
This tutorial will show you a method of creating multilingual sites in Tuiuiu by duplicating the page tree.
...
.. code-block:: python
    ...
    from tuiuiu.tuiuiucore.models import Page
    from tuiuiu.tuiuiuadmin.edit_handlers import MultiFieldPanel, PageChooserPanel
