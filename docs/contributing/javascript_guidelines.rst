...
Tuiuiu provides some tooling configuration to help check your code meets the
...
This will lint all the JS in the tuiuiu project, excluding vendor
...
edit the ``.jscsrc`` file in the tuiuiu project root.
