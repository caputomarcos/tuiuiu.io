...
If you have ``tuiuiu.tuiuiuimages`` installed, and the value happens to be an
instance of ``tuiuiuimages.models.Image`` (or a custom model that subclasses
``tuiuiuimages.models.AbstractImage``), a thumbnail of that image will be
rendered.

If you have `tuiuiu.tuiuiudocs` installed, and the value happens to be an
instance of `tuiuiudocs.models.Document` (or a custom model that subclasses
``tuiuiudocs.models.AbstractDocument``), a link to that document will be
