...
The ``tuiuiuapi`` module can be used to create a read-only, JSON-based API for public Tuiuiu content.
...
See :doc:`installation` and :doc:`configuration` if you're looking to add this module to your Tuiuiu site.
