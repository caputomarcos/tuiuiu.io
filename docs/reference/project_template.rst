...
The templates directory contains ``base.html``, ``404.html`` and ``500.html``. These files are very commonly needed on Tuiuiu sites to they have been added into the template.
