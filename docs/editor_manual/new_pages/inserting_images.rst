...
#. *Tags* allows you to associate tags with the image you are uploading. This allows them to be more easily found when searching. Each tag should be separated by a space. Good practice for creating multiple word tags is to use an underscore between each word (e.g. western_yellow_tuiuiu).
...
In addition, Tuiuiu allows you to choose an alignment for you image.
...
.. Note::
    The display of images aligned in this way is dependent on your implementation of Tuiuiu, so you may get slightly different results.
